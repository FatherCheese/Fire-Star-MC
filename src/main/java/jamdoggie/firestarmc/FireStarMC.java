...
public class FireStarMC implements ModInitializer, GameStartEntrypoint {
	...
	public static final int WORLD_INDEX_OFFSET = 500;
	public static final int MULTI_WORLD_DEFAULT_WORLD_INDEX = 499;
    ...
    public void onInitialize() {
		...
		worldAPI.getRegisteredWorlds().add(new RegisteredMultiWorld("testWorld", "testSeed".hashCode(), WORLD_INDEX_OFFSET));
    }
